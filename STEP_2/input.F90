...
! ------- modules
        ...
        print*,'  STEP_2 (G.Amati, CINECA)                           '
        print*,'  * move to fortran 90                                 '
        print*,'  * removed common  --> using module                   '
        print*,'  * removed fourier subroutine                         '
        print*,'  * allocatable vector                                 '
        print*,'  * modified input: size from input file               '
